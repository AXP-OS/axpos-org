...
*   Mandatory step to fix F-Droid repository priority to ensure app updates for AXP.OS: `F-Droid > Settings > Repositories > Long-press and drag 'AXP.OS - Stable' (optionally 'AXP.OS - Cutting Edge') above 'F-Droid'`.
*   Install a browser, we recommend our [AOSmium](/Browser) or choose another browser at your discretion.
...
*   \[AXP.OS currently ships without VoWiFi support\] You may consider disabling Wi-Fi calling to not let your carrier learn such information about IP addresses, access-points, and potentially more accurate location.
...
- [unplugTrump](https://www.kuketz-blog.de/unplugtrump-free-yourself-digitally-from-trump-and-big-tech/), free yourself from Trump and BigTech
...
The whole document is a markdown replacement of the original made by: [Divested Computing Group](https://web.archive.org/web/20241231213231/https://divestos.org/pages/post_install), extended for AXP.OS.
